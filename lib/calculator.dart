...
equation=equation.substring(0,equation.length-1);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Center(child: Text("CALCULATOR",style: TextStyle(color: Colors.black),)),backgroundColor: Colors.amber,),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                RaisedButton(padding: EdgeInsets.fromLTRB(30, 10, 115, 10), 
                onPressed: (){},
                shape: StadiumBorder(),
                color: Colors.green,
...
Widget calculatebutton(String btntext,Color btncolor,Color textcolor){
    return Expanded(
      child: Container(
        child:RaisedButton(onPressed:()=>buttonpressed(btntext),
